...
main.html - welcome and choose add or view
add.html - make a reservation
view.html - view reservations and wait list
...
Should work so that when you go and type:
 localhost:300/main you see the html page
 localhost:300/add you see the html page
localhost:300/view you see the html page
* Use jQuery to run AJAX calls to GET and POST data from users to the Express server (npm install?)
